...
begin
  ...
  begin
    form1.neopixel1.FillStrip(Strtoint(Red.Text), Strtoint(Green.Text), Strtoint(Blue.Text), Strtoint(White.Text), ShowPixels.checked);  // fill strip and ShowPixels
  end
  else // fill segment
  begin
    form1.neopixel1.FillSegment(Strtoint(Red.Text), Strtoint(Green.Text), Strtoint(Blue.Text), Strtoint(White.Text),     // fill segment and ShowPixels
