...
begin
  if RadioStrip.Checked then
    form1.neopixel1.ShiftStripConfig('R', wrap.Checked, ShowPixel.Checked)  // shift config
  else
    form1.neopixel1.ShiftSegmentConfig(strtoint(pixelfirst.text), strtoint(pixelend.text), 'R', wrap.Checked, ShowPixel.Checked);  // shift config
  Close;
end;
