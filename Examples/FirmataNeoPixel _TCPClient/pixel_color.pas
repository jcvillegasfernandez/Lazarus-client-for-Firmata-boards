...
begin
  FormNeo1.NeoPixel1.PixelColor(strtoint(pixelnumber.text), Strtoint(Red.Text), Strtoint(Green.Text), Strtoint(Blue.Text), Strtoint(white.Text), ShowPixel.checked, true);
  Close;
end;
