...
begin
  ...
  begin
   FormNeo1.NeoPixel1.FadeStripConfig(Strtoint(Red.Text), Strtoint(Green.Text), Strtoint(Blue.Text), Strtoint(White.Text));
  end
  else // fill segment
  begin
    FormNeo1.NeoPixel1.FadeSegmentConfig(Strtoint(Red.Text), Strtoint(Green.Text), Strtoint(Blue.Text), Strtoint(White.Text),
