...
procedure TCopy_Pixels1.MoveClick(Sender: TObject);
begin
  form1.neopixel1.MovePixels(strtoint(pixelsrc.text), strtoint(Pixeldest.text), strtoint(Pixelcount.text), ShowPixel.Checked);  // shift config
  Close;
end;
