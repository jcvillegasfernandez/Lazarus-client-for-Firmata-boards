...
// new extensions
#define PIN_MODE_PS2MOUSE       0x11 // pin configured for ps 2 mouse
#define PIN_MODE_NEOPIXEL       0x12 // pin configures for neopixel

#define PIN_MODE_IGNORE         0x7F // pin configured to be ignored by digitalWrite and capabilityResponse
#define TOTAL_PIN_MODES         (16 + 2) // two new extensions
